...
var memory_array = [
'js/images/queen-of-hearts.PNG',
'js/images/queen-of-diamonds.PNG',
'js/images/king-of-hearts.PNG',
'js/images/king-of-diamonds.PNG',
'js/images/queen-of-hearts.PNG',
'js/images/queen-of-diamonds.PNG',
'js/images/king-of-hearts.PNG',
'js/images/king-of-diamonds.PNG'
...
// document.getElementById("output").innerHTML = function tiles_flipped() {
		...
		if(memory_values.length == 0){
			...
			if(memory_values[0] == memory_values[1]){
				...
				function flip2Back(){
            	    ...
            	    tile_1.innerHTML = "";
				    tile_2.style.background = 'url(js/images/back.PNG) no-repeat';
            	    tile_2.innerHTML = "";
				    // Clear both arrays
				    memory_values = [];
            	    memory_tile_ids = [];
